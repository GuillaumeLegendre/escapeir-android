...
public class Gesture {
	 ...
	 */
	public Gesture(int minNumOfPoint,int marginErrorDiag,int marginErrorBack,int marginErrorCircle){
		if((minNumOfPoint<0)   ||
		   (marginErrorDiag<0) ||
		   (marginErrorBack<0) ||
		   (marginErrorCircle<0)){
	...
	private boolean isCheatCode(){
		...
		if((firsPoint.x<Game.getTheGame().getWidth()-150) || (firsPoint.y<Game.getTheGame().getHeight()-150)){
			return false;
		}
		int numOfPoint=1;
		int badPoint=0;
